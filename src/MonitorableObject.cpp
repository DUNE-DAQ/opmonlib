...
void
MonitorableObject::register_node(ElementId name, NewNodePtr p)
{
...
void
MonitorableObject::publish(google::protobuf::Message&& m, CustomOrigin&& co, OpMonLevel l) const noexcept
{
...
opmon::MonitoringTreeInfo
MonitorableObject::collect() noexcept
{
...
void
MonitorableObject::set_opmon_level(OpMonLevel l) noexcept
{
...
void
MonitorableObject::inherit_parent_properties(const MonitorableObject& parent)
{
